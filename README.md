...
- **Python** is the most popular language (421, ~67%), well ahead of R (145) and SQL (51).
- Average reported salary is **~$53,900** (median ~$53,000), ranging from the `$0–40k` bracket up to `$150k+`.
- The **United States** dominates the respondent pool (261, ~41%), followed by **India** (73), the **UK** (40), **Canada** (32), and **Nigeria** (30).
- **Tech/IT** (169), **Finance/Banking** (97), and **Healthcare** (86) are the top three industries represented.
